<div>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a href="{{url('settings/services')}}" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white"> <i data-feather="arrow-left" class="w-4 h-4 mr-2"></i> Go Back</a>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    ...
                    <div>
                        <label> Name</label>
                        <input type="text" class="input w-full border @error('service.name')border-theme-6 @enderror  mt-2" wire:model="service.name">
                        @error('service.name')<div class="text-theme-6 mt-2">{{$message}}</div>@enderror
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="input w-full border @error('service.description')border-theme-6 @enderror mt-2" wire:model="service.description"></textarea>
                        @error('service.description')<div class="text-theme-6 mt-2">{{$message}}</div>@enderror
                    ...
                    <div class="mt-3">
                        ...
                        <div class="fallback">
                            ...
                            @else
                            <img class="w-40 p-3" src="{{ $service->image }}">
                            @endif
                    ...
                    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                        <div class="mr-auto">
                            <a href="{{url('settings/services')}}" class="button w-24 border dark:border-dark-5 text-gray-700 dark:text-gray-300 mr-1">Cancel</a>
    ...
    <x-dialog-modal wire:model="confirmingDelete">
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="ml-2" wire:click="delete({{$service->id}})" wire:loading.attr="disabled">
                {{ __('Delete') }}
                </x-button>
        </x-slot>
    </x-dialog-modal>

...
<div>
    ...
    border-color: rgba(113, 128, 150, var(--border-opacity));">
        ...
        <ul class="border-t border-theme-24 border-opacity-25 border-gray-600  py-5 hidden">
            ...
            <li>
                <a href="{{url('orders')}}" class="menu  @if(request()->routeIs('orders')) menu--active @endif">
                    <div class="menu__icon " :class="{ 'text-gray-800': !dark }" :class="{ 'text-gray-200': dark }"> <i data-feather="box"></i> </div>
                    <div class="menu__title " :class="{ 'text-gray-800': !dark }" :class="{ 'text-gray-200': dark }"> Orders</div>
                </a>
            </li>


            <li>
                <a href="{{url('products')}}" class="menu  @if(request()->routeIs('products')) menu--active @endif">
                    <div class="menu__icon " :class="{ 'text-gray-800': !dark }" :class="{ 'text-gray-200': dark }"> <i data-feather="monitor"></i> </div>
                    <div class="menu__title " :class="{ 'text-gray-800': !dark }" :class="{ 'text-gray-200': dark }"> Products</div>
                </a>
            </li>

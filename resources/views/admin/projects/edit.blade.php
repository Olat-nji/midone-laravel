    ...
    <form wire:submit.prevent="save">
        <div class="intro-y box py-10 sm:py-20 mt-5">
            ...
            <div class="px-5 mt-10">
                <div class="font-medium text-center text-lg">Edit {{$project->name}}</div>
                <div class="text-gray-600 text-center mt-2">Edited Information Cannot be Retrieved</div>
            ...
            <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5" x-show="step === 3">
                ...
                <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                    ...
                    <div class="intro-y col-span-12 sm:col-span-12">
                        ...
                        <input type="text" class="input w-full border flex-1" wire:model="phone">
                    </div>


                    <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                        <a class="button w-24 justify-center block bg-red-500 text-white mr-2" href="{{url('projects/'.$project->id)}}">Cancel</a>

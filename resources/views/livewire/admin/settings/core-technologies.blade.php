<div>
@section("header")
<h2 class="font-semibold text-xl text-gray-800 leading-tight"  >Core Technologies</h2>
    @endsection
    <div class="container px-6 mx-auto grid">
            ...
            <div class="font-sans mt-5">
               <span class="text-base text-gray-800 font-bold">&laquo;</span> <a href="{{url('settings')}}" class="text-base md:text-sm text-gray-800 font-bold no-underline hover:underline">Back to Settings</a>
               
            </div>
                 
                    <div class="px-4 py-3 mb-8 mt-8  rounded-lg  dark:bg-gray-800">

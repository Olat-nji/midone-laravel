      ...
      >
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="block">
                ...
                <input class="block mt-1 w-full form-input rounded-md shadow-sm" type="email" name="email" :value="old('email', $request->email)" required autofocus />
            </div>
